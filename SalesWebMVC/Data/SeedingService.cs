...
namespace SalesWebMVC.Data
{
    public class SeedingService
    {
        ...
        public void Seed()
        {
            ...
            Seller s1 = new Seller(1, "Micael", "micael@gmail.com", new DateTime(2002, 4, 30), 4000.00, d1);
            Seller s2 = new Seller(2, "Maria", "maria@gmail.com", new DateTime(1994, 1, 25), 2000.00, d3);
            Seller s3 = new Seller(3, "Bob", "bob@gmail.com", new DateTime(1985, 7, 5), 3000.00, d2);
            Seller s4 = new Seller(4, "Capoeira", "capoeira@gmail.com", new DateTime(6000, 10, 2), 4000.00, d2);
            Seller s5 = new Seller(5, "Deiro", "deiro@gmail.com", new DateTime(1999, 12, 1), 3000.00, d3);
            Seller s6 = new Seller(6, "Ana", "ana@gmail.com", new DateTime(1992, 4, 20), 8000.00, d4);
